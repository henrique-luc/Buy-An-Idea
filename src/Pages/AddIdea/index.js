					...
					<form onSubmit={handleSubmit(onSubmitFunction)}>
						<section>
							<div className="container_addIdea-main-form-video">
								...
								<p>
									Supreenda seus investidores contando as suas
									melhores ideias em um vídeo. Sugerimos um
									material de até 2 min.
								</p>
								<iframe
									width="100%"
									height="100%"
							...
							<div>
								<h4>Sobre</h4>
								<p>
									Chegou a hora de inspirar os seus
									investidores com uma bela história sobre a
									sua iniciativa.
								</p>
								<Textarea
									height="160"
						...
						<section>
							...
							<div className="container_addIdea-main-form-core-itens">
								<div className="container_addIdea-main-form-core-first">
									<h4>Payback</h4>
									<p>
										Coloque aqui o retorno do investimento
									</p>
									<Input
										register={register}
										name={"payback"}
